...
exports.getJobs = function (request, reply) {
    ...
    var reels = internals.Gills.settings.plugins.tacklebox.getReels();
    var reelList = [];
    for (var i = 0; i < reels.length; i++) {
       var reel = internals.Gills.settings.plugins.tacklebox.getReel(reels[i]);
       reelList.push(reel);
    }
    //console.log(jobList);
    var config = {
...
exports.deleteReel = function (request, reply) {
    ...
    internals.Gills.settings.plugins.tacklebox.deleteReel(request.params.id);
    reply.redirect('/gills/jobs');
};
...
exports.updateReel = function (request, reply) {
    ...
    var updateConfig = internals.Gills.settings.plugins.tacklebox.updateReel(config.id, config);
