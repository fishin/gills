...
exports.getReelView = function (request, reply) {
    ...
    internals.Reel.getReelConfig(request.params.reelId, (config) => {
...
exports.getReelCreateView = function (request, reply) {
    ...
    internals.Reel.getReelCreateConfig((config) => {
...
exports.createReel = function (request, reply) {
    ...
    internals.Reel.createReel(request.payload, (createConfig) => {
...
exports.updateReel = function (request, reply) {
    ...
    internals.Reel.updateReel(request.params.reelId, request.payload, (updateConfig) => {
