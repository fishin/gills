...
exports.createReel = function (request, reply) {
    ...
    reply.redirect(internals.Reel.settings.viewPath + '/reel/' + createConfig.id);
};

exports.deleteReel = function (request, reply) {

    internals.Reel.deleteReel(request.params.reelId);
    reply.redirect(internals.Reel.settings.viewPath + '/jobs');
};
...
exports.updateReel = function (request, reply) {
    ...
    reply.redirect(internals.Reel.settings.viewPath + '/reel/' + updateConfig.id);
};
