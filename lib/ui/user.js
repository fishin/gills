        ...
        if (request.payload.name === 'admin') {
            Wreck.get(internals.User.settings.api.url + '/user/byname/' + request.payload.name, function (err, resp, pl) {
                ...
                if (!adminUser) {
                    ...
                    Wreck.post(internals.User.settings.api.url + '/user', { headers: { 'Content-Type': 'application/json' }, payload: JSON.stringify(adminConfig) }, function (err, resp, pl) {
                    ...
                    Wreck.post(internals.User.settings.api.url + '/user/' + adminUser.id + '/validate', { headers: { 'Content-Type': 'application/json' }, payload: JSON.stringify(userConfig) }, function (err, resp, pl) {
            ...
            Wreck.get(internals.User.settings.api.url + '/user/byname/' + request.payload.name, function (err, resp, pl) {
                ...
                if (pl) {
                    ...
                    Wreck.post(internals.User.settings.api.url + '/user/' + user.id + '/validate', { headers: { 'Content-Type': 'application/json' }, payload: JSON.stringify(config) }, function (err, resp, pl) {
