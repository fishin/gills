...
exports.clearQueue = function (request, reply) {
    ...
    Wreck.delete(internals.Queue.settings.api.url + '/queue', function (err, resp, pl) {
...
exports.removePullRequest = function (request, reply) {
    ...
    Wreck.delete(internals.Queue.settings.api.url + '/queue/' + request.params.jobId + '/pr/' + request.params.pr, function (err, resp, pl) {
