...
exports.getPullRequestRunView = function (request, reply) {
    ...
    internals.Run.getPullRequestRunConfig(request.params.jobId, request.params.pr, request.params.runId, function (config) {
...
exports.getTestView = function (request, reply) {
    ...
    internals.Run.getTestConfig(request.params.jobId, request.params.runId, function (config) {
...
exports.getCoverageView = function (request, reply) {
    ...
    internals.Run.getCoverageConfig(request.params.jobId, request.params.runId, function (config) {
...
exports.deleteRuns = function (request, reply) {
    ...
    internals.Run.deleteRuns(request.params.jobId, function () {
...
exports.cancelPullRequest = function (request, reply) {
    ...
    internals.Run.cancelPullRequest(request.params.jobId, request.params.pr, request.params.runId, function () {
