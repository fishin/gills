...
exports.getTestView = function (request, reply) {
    ...
    internals.Run.getTestConfig(request.params.jobId, request.params.runId, 'test.lab', function (config) {
...
exports.getCoverageView = function (request, reply) {
    ...
    internals.Run.getCoverageConfig(request.params.jobId, request.params.runId, 'test.lab', function (config) {
