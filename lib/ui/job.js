...
exports.getJobView = function (request, reply) {
    ...
    var config = internals.Job.getJobConfig(request.params.id);
    reply.view('layout', config);   
};

exports.getJobCreateView = function (request, reply) {

    var config = internals.Job.getJobCreateConfig(request.params.id);
    reply.view('layout', config);   
};

exports.updateJob = function (request, reply) {

    var config = internals.Job.updateJob(request.params.id, request.payload);
    reply.redirect('/gills/job/'+ request.params.id);
};

exports.deleteJob = function (request, reply) {

    internals.Job.deleteJob(request.params.id);
