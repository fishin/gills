...
exports.createJob = function (pl) {
    ...
    var payload = internals.convertPayload(pl);
    var config = {
        name: payload.name,
...
internals.convertPayload = function(pl) {

    var payload = pl;
    if (pl.headCommand1) {
        payload.head = [ pl.headCommand1 ];
    }
    if (pl.bodyCommand1) {
        payload.body = [ pl.bodyCommand1 ];
    }
    if (pl.tailCommand1) {
        payload.tail = [ pl.tailCommand1 ];
    }
    return payload;
}
