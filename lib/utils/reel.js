...
exports.getReelCreateConfig = function (cb) {
    ...
    var reel = {};
    var config = {};
    Wreck.get('http://localhost:8081/api/reels', function (err, resp, pl) {
...
exports.getReelConfig = function (reelId, cb) {
    ...
    Wreck.get('http://localhost:8081/api/reel/' + reelId, function (err, resp, pl) {
...
exports.createReel = function (payload, cb) {
    ...
    Wreck.post('http://localhost:8081/api/reel', { headers: { 'Content-Type': 'application/json' }, payload: JSON.stringify(config) }, function (err, resp, pl) {
...
exports.deleteReel = function (reelId, cb) {
    ...
    Wreck.delete('http://localhost:8081/api/reel/' + reelId, function (err, resp, pl) {
...
exports.updateReel = function (reelId, payload, cb) {
    ...
    Wreck.post('http://localhost:8081/api/reel/' + reelId, { headers: { 'Content-Type': 'application/json' }, payload: JSON.stringify(config) }, function (err, resp, pl) {
