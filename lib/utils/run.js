...
exports.runJob = function (id) {

    internals.Run.settings.plugins.tacklebox.startRun(id);
};

exports.getRunConfig = function (id, run_id) {

    var run = internals.Run.settings.plugins.tacklebox.getRun(run_id);
    var job = internals.Run.settings.plugins.tacklebox.getJob(id);
    var commands = [];
...
exports.deleteRun = function (id, run_id) {

    internals.Run.settings.plugins.tacklebox.deleteRun(id, run_id);
};
