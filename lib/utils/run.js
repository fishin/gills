...
exports.getRunConfig = function (jobId, runId, cb) {
    ...
    internals.Run.getCommonConfig(function (commonConfig) {
        ...
        Wreck.get('http://localhost:8081/api/job/' + jobId, function (err, resp, pl) {
            ...
            Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId, function (err, resp, pl) {
                ...
                Wreck.get('http://localhost:8081/api/job/' + jobId + '/runs', function (err, resp, pl) {
                    ...
                    Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + run.id + '/test/lab.json', function(err, resp, pl) {
                        ...
                        Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId + '/archive', function (err, resp, pl) {
    ...
    internals.Run.getCommonConfig(function (commonConfig) {
        ...
        Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId, function (err, resp, pl) {
            ...
            Wreck.get('http://localhost:8081/api/job/' + jobId, function (err, resp, pl) {
                ...
                var job = JSON.parse(pl);
                Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId + '/test/lab.json', function (err, resp, pl) {
...
exports.getFileConfig = function (jobId, runId, file, cb) {
    ...
    internals.Run.getCommonConfig(function (commonConfig) {
        ...
        Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId + '/archive/' + file, function (err, resp, pl) {
...
exports.deleteRun = function (jobId, runId, cb) {
    ...
    Wreck.delete('http://localhost:8081/api/job/' + jobId + '/run/' + runId, function (err, resp, pl) {
...
exports.cancelRun = function (jobId, runId, cb) {
    ...
    Wreck.get('http://localhost:8081/api/job/' + jobId + '/run/' + runId + '/cancel', function (err, resp, pl) {
...
exports.cancelPullRequest = function (jobId, number, token, runId, cb) {
    ...
    bait.getPullRequest(jobId, number, token, function(pr) {
        ...
        //internals.Run.settings.plugins.tacklebox.cancelRun(jobId, pr, runId);
