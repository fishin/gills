...
//        }
    ...
    server.route([
        ...
        { method: 'GET', path: settings.apiPath + '/queue/{job_id}/add', config: { handler: ui.Queue.addJob, description: "add job to queue" } },
        { method: 'GET', path: settings.apiPath + '/queue/{job_id}/remove', config: { handler: ui.Queue.removeJob, description: "remove job from queue" } },
