...
exports.register = function (plugin, options, next) {
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.ui.basePath + '/job', config: { handler: Gills.createJob, description: "create job" } },
        { method: 'GET', path: settings.ui.basePath + '/job/{id}', config: { handler: Gills.updateJob, description: "update job" } },
