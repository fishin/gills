...
/*
        { method: 'GET', path: settings.apiPath + '/queue/create', config: { handler: gills.getQueue, description: "get queue" } },
        { method: 'POST', path: settings.apiPath + '/queue', config: { handler: gills.createQueue, description: "create queue" } },
        { method: 'GET', path: settings.apiPath + '/queue/{id}/delete', config: { handler: gills.deleteQueue, description: "delete queue" } },
*/
