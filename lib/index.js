...
//        }
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.apiPath + '/job/{id}/run/{run_id}', config: { handler: gills.getRun, description: "get run" } },
        { method: 'GET', path: settings.apiPath + '/job/{id}/run/{run_id}/delete', config: { handler: gills.deleteRun, description: "delete run" } },
        ...
        { method: 'GET', path: settings.apiPath + '/reel/create', config: { handler: gills.getReel, description: "create reel" } },
        { method: 'GET', path: settings.apiPath + '/reel/{id}', config: { handler: gills.getReel, description: "get reel" } },
        { method: 'POST', path: settings.apiPath + '/reel/{id}', config: { handler: gills.updateReel, description: "update reel" } },
        { method: 'POST', path: settings.apiPath + '/reel', config: { handler: gills.createReel, description: "create reel" } },
        { method: 'GET', path: settings.apiPath + '/reel/{id}/delete', config: { handler: gills.deleteReel, description: "delete reel" } },
