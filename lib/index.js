...
//        }
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.apiPath + '/job', config: { handler: gills.getJob, description: "get job" } },
        { method: 'POST', path: settings.apiPath + '/job', config: { handler: gills.createJob, description: "create job" } },
        { method: 'GET', path: settings.apiPath + '/job/{id}', config: { handler: gills.updateJob, description: "update job" } },
