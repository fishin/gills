...
//        }
    ...
    plugin.route([
        ...
        { method: 'GET', path: settings.apiPath + '/job/{job_id}/run', config: { handler: ui.Run.runJob, description: "run job" } },
        ...
        { method: 'GET', path: settings.apiPath + '/job/{job_id}/run/{run_id}', config: { handler: ui.Run.getRun, description: "get run" } },
        { method: 'GET', path: settings.apiPath + '/job/{job_id}/run/{run_id}/delete', config: { handler: ui.Run.deleteRun, description: "delete run" } },
        { method: 'GET', path: settings.apiPath + '/reel', config: { handler: ui.Reel.getReel, description: "create reel" } },
        { method: 'GET', path: settings.apiPath + '/reel/{reel_id}', config: { handler: ui.Reel.getReel, description: "get reel" } },
